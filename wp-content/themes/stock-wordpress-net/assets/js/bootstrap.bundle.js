...
(function (global, factory) {
  ...
  function getLayoutRect(element) {
    ...
    // Fixes https://github.com/popper/assets/js/popper-core/issues/1223
  ...
  function getTrueOffsetParent(element) {
    if (!isHTMLElement(element) || // https://github.com/popper/assets/js/popper-core/issues/837
  ...
  function getContainingBlock(element) {
    ...
    while (isHTMLElement(currentNode) && ['html', 'body'].indexOf(getNodeName(currentNode)) < 0) {
      ...
      // https://developer.mozilla.org/en-US/docs/Web//assets/css/Containing_block#identifying_the_containing_block
  ...
  function getWindowScrollBarX(element) {
    // If <html lang='en'> has a CSS width greater than the viewport, then this will be
    // incorrect for RTL.
    // Popper 1 is broken in this case and never had a bug report so let's assume
    // it's not an issue. I don't think anyone ever specifies width on <html lang='en'>
    // anyway.
  ...
  // of the `<html lang='en'>` and `<body>` rect bounds if horizontally scrollable
  ...
  */
  ...
  function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
    ...
    if (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) {
      if (getNodeName(offsetParent) !== 'body' || // https://github.com/popper/assets/js/popper-core/issues/1078
